...
public class TenantDataSourceServiceImpl extends ServiceImpl<TenantDataSourceMapper, TenantDataSource> implements TenantDataSourceService {
    ...
    public TenantDataSourceServiceImpl() {
        log.info("------init TenantDataSourceServiceImpl----- ");
    }
    ...
    public BaseResult<Integer> saveTenantDataSource(TenantDataSourceDTO dto) {
        ...
        if (result) {
            ...
            BeanUtils.copyProperties(tenantDataSource, tenantDataSourceDubboDTO);
//            dataSourceChangeProvider.addDataSource(tenantDataSourceDubboDTO);
        } else {
